...
# p(x>92)
pnorm(92,76,5,lower.tail = FALSE)
plot(51:101,dnorm(51:101,76,5), main = "Vida media para la ciudad   = 76", xlab = "esperanza de vida de las personas", ylab = "probabilidad" )
```
...
# media = 76 Varianza = 25
# p(55<X)+ p(X>75)
pnorm(75,76,5,lower.tail = FALSE) + pnorm(55,76,5)
plot(20:131,dnorm(20:131,76,5), main = "Vida media para la ciudad   = 76", xlab = "esperanza de vida de las personas", ylab = "probabilidad" )
```
